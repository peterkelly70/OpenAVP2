...
func test_mirrors_one_axis_and_scales() -> void:
	...
	assert_almost_eq(converted.x, -1.0, 0.001)
	assert_almost_eq(converted.y, 2.0, 0.001)
	assert_almost_eq(converted.z, 3.0, 0.001)
